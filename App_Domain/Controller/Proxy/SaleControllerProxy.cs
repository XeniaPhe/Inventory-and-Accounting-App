...
public class SaleControllerProxy : ControllerProxyBase<Sale, SaleController,  SaleService>, ISaleController
{
    internal SaleControllerProxy(DbContextOptions<ApplicationDbContext> contextOptions) : base(contextOptions) { }
}