...
public class CurrencyControllerProxy : ControllerProxyBase<Currency, CurrencyController, CurrencyService>, ICurrencyController
{
    internal CurrencyControllerProxy(DbContextOptions<ApplicationDbContext> contextOptions) : base(contextOptions) { }
}